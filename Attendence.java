...
public class Attendence {
    ...
    public void MarkAttendence(String sid) {
        try {
            System.out.println("marking attendace try block");
            studentAtt.add(sid);
            if (studentAtt.size() >= thresholdFactor) {
                System.out.println("attnd 1 if loop.");
                /**
                ...
                if (cnter >= thresholdFactor - 5) {
                    ...
                    if (!subject.equals("")) {
                        ...
                        if ((!chkAttendenceExists(sid, Date, subject, fromtime, totime))) {
                            ...
                            JOptionPane.showMessageDialog(null, "ATTENDENCE MARKED FOR Employee " + getStudentName(sid) + " At Time " + this.time);
                        }
                    }
                }
...
//    -----------------------------------------second try insert dat----------------------------------
//    public void MarkAttendence(String sid) {
//    try {
//        System.out.println("marking attendance try block");
//        
//        String currentDate = new Date().toString(); // Get current date and time
//        
//        String query = "INSERT INTO attendance2 (sid, attDate) VALUES (?,?)";
//        PreparedStatement statement = dbcon.prepareStatement(query);  
//        System.out.println("marking attendance try block 1");
//        
//        statement.setString(1, sid);
//        statement.setString(3, currentDate);
//        System.out.println("marking attendance try block 2");
//        int rowsInserted = statement.executeUpdate();
//        System.out.println("marking attendance try block 3");
//        if (rowsInserted > 0) {
//            System.out.println("Attendance marked successfully for student ID: " + sid);
//        } else {
//            System.out.println("Failed to mark attendance for student ID: " + sid);
//        }
