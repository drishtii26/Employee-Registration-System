    ...
    public void sendMessage(String sid, String subject, String percent) {
            try {
                ...
                if (rs.next()) {
                    ...
                    String message = " Your Attendence is very Irregular For COMPANY, Please visit company for discussion.";
    ...
    public void sendemailMessage(String sid, String subject, String percent) {
            try {
                ...
                if (rs.next()) {
                    ...
                    String message = " Your Attendence is very Irregular For COMPANY, Please visit OFFICE for discussion.";
